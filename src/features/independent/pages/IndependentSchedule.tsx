...
const IndependentSchedule: React.FC = () => {
  // Placeholder data
  const sessions = [
    { id: 1, title: 'Private Math Lesson', teacher: 'Mr. Smith', time: '2024-01-15 10:00', room: 'Room 101' },
    { id: 2, title: 'Chemistry Course', teacher: 'Ms. Johnson', time: '2024-01-16 14:00', room: 'Room 202' },
  ];
